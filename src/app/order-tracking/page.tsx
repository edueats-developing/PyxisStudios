...
function OrderTracking({ user }: OrderTrackingProps) {
  const [orders, setOrders] = useState<Order[]>([])
  const [loading, setLoading] = useState(true)
  const [error, setError] = useState<string | null>(null)

  useEffect(() => {
    console.log('OrderTracking component mounted, user:', user)
    fetchOrders()
  }, [user])
...
export default withAuth(OrderTracking, ['admin', 'driver', 'customer'])