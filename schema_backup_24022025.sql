...
CREATE POLICY "Allow public read access to restaurant ratings" ON "public"."restaurants" FOR SELECT USING (true);



CREATE POLICY "Allow public read access to reviews for ratings" ON "public"."reviews" FOR SELECT USING (true);
...
CREATE POLICY "Authenticated users can insert into category column" ON "public"."restaurants" FOR INSERT TO "authenticated" WITH CHECK (true);
